...
public class RedAmpAuton extends SequentialCommandGroup {
...
private final Arm m_arm;
   ...
   */
  public RedAmpAuton(RevSwerve swerve, Rollers rollers, Flywheels flywheels, Arm arm) {
    ...
    addCommands(
      ...
      new DriveDistance(-1.0, m_swerve), new RotateDistance(90.0, m_swerve), m_arm.armToAmpCommandAuto(), m_arm.stopArmAuto(),
